...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Selamat Datang di Form Jenis Menu</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                        <li class="breadcrumb-item active">Jenis Menu</li>
                        <li class="breadcrumb-item active">Form Jenis Menu</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="input-group-text">
                          <i class="fa fa-adjust"></i>
                                            ...
                                            <input id="name" name="name" type="text" class="form-control" placeholder="Masukkan Nama Jenis Mnu" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
